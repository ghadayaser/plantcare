    ...
    <header className="bg-gray-200 fixed inset-x-0 top-0 z-50">
      <nav className="flex items-center justify-between px-6 py-3 lg:px-8" aria-label="Global">
        ...
        <Link to={'home'} className="lg:pe-4">
          ...
          <img className="" src={logo} width={30} alt />
        </Link>
        ...
        <div className="hidden lg:flex lg:gap-x-2 capitalize">
          ...
          <NavLink to={'Wateranalysis'} className=" font-medium text-gray-900">Wateranalysis</NavLink>
          <NavLink to={'Leafdiagnosis'} className=" font-medium text-gray-900">Leafdiagnosis</NavLink>
          <NavLink to={'profile'} className=" font-medium text-gray-900">profile</NavLink>
          <NavLink to={'setting'} className=" font-medium text-gray-900">setting</NavLink>
        </div>
        <div className="hidden lg:flex lg:flex-1 lg:justify-end space-x-3">
          <NavLink to={'/'} className=" font-medium text-gray-900">Signup</NavLink>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <NavLink to={'Wateranalysis'} className="block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50">Wateranalysis</NavLink>
                <NavLink to={'Leafdiagnosis'} className="block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50">Leafdiagnosis</NavLink>
                <NavLink to={'profile'} className="block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50">profile</NavLink>
                <NavLink to={'setting'} className="block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50">setting</NavLink>
              </div>
              <div className="py-6">
                <NavLink to={'/'} className="block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50">Signup</NavLink>
